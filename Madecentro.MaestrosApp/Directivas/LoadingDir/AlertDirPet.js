(function () {
    ...
    angular.module('appmadecentro').directive('alertdialog', ['$timeout', '$location', '$route', function ($timeout, $location, $route) {
        return {
            scope: {
                getdata: '&',
                canceldata: '&',
            ...
            restrict: 'E',
            templateUrl: 'Directivas/LoadingDir/AlertDir.html',
